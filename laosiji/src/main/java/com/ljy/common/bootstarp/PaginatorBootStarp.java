 ...
 *
 */
public class PaginatorBootStarp implements Serializable{
	...
	private static final long serialVersionUID = 1L;
	 ...
	 private final static int PAGESIZE = 10; //默认显示的记录数 
	    ...
	    public PaginatorBootStarp() {
	    }

	    //构造方法
	    public PaginatorBootStarp(int nowpage, int pagesize) {
	        //计算当前页  
	        if (nowpage <= 0) {
	            this.nowpage = 1;
	        } else {
	    ...
	    // 构造方法
	    public PaginatorBootStarp(int nowpage, int pagesize, String sort, String order) {
	        // 计算当前页  
	        if (nowpage < 0) {
	            this.nowpage = 1;
	        } else {
