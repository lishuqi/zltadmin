 ...
 * Generated at: 2016-10-18 07:33:38 UTC
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t<div class=\"modal fade\" id=\"myModalPermissionTree\" tabindex=\"-1\" role=\"dialog\" \r\n");
      ...
      out.write("\t\t\t\t\t\t<ul id=\"treePermission\" class=\"ztree\" style=\"width:700px;heigth:100%;\"></ul>\r\n");
      out.write("\t\t\t\t\t\t<span id=\"roleId\" style=\"display: none\"></span>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t        }\r\n");
      out.write("\t\t    };\r\n");
      out.write("\t\t    var nodesPermission;\r\n");
      out.write("\t\t    \r\n");
      out.write("\t\t    function initTreeNodePermission(){\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl:'");
      out.print(basePath);
      out.write("Manage/Permission/tree.do?roleId='+$(\"#roleId\").val(),\r\n");
      out.write("\t\t\t\t\ttype:'GET',\r\n");
      out.write("\t\t\t\t\tdataType:'text',\r\n");
      out.write("\t\t\t\t\tasync:false,\r\n");
      out.write("\t\t\t\t\tsuccess:function(result){\r\n");
      out.write("\t\t\t\t\t\tnodesPermission = eval('('+result+')');\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t var t2 = $(\"#treePermission\");\r\n");
      out.write("\t\t\t     t2 = $.fn.zTree.init(t2, settingTree, nodesPermission);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t//授权modalandtree\r\n");
      out.write("\t\t\tfunction showPermissionTree(roleId){\r\n");
      out.write("\t\t\t\t$('#myModalPermissionTree').modal('show');\r\n");
      out.write("\t\t\t\t$(\"#roleId\").val(roleId);\r\n");
      out.write("\t\t\t\tinitTreeNodePermission();\r\n");
      out.write("\t\t\t\t//授权回显\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl:'");
      out.print(basePath);
      out.write("Manage/Permisssion/anthReturnView.do?roleId='+roleId,\r\n");
      out.write("\t\t\t\t\ttype:'GET',\r\n");
      out.write("\t\t\t\t\tsuccess:function(result){\r\n");
      out.write("\t\t\t\t\t\tfor(var i in result){\r\n");
      out.write("\t\t\t\t\t\t\tvar treeObj = $.fn.zTree.getZTreeObj(\"treePermission\");\r\n");
      out.write("\t\t\t\t\t\t\tvar node = treeObj.getNodeByParam(\"permissionId\",result[i].permissionId);\r\n");
      ...
      out.write("\t\t\t        \tif(nodeSelect[i].permissionId!=null && nodeSelect[i].permissionId != \"\" && typeof(nodeSelect[i].permissionId) != 'undefinde'){\r\n");
      out.write("\t\t\t        \t\tarr.push(nodeSelect[i].permissionId);\r\n");
      out.write("\t\t\t        \t}\r\n");
      out.write("\t\t        \t}\r\n");
      out.write("\t\t        }\r\n");
      ...
      out.write("\t\t        \turl:'");
      out.print(basePath);
      out.write("Manage/Permission/authenrization.do',\r\n");
      out.write("\t\t        \ttype:'POST',\r\n");
      out.write("\t\t        \tdata:eval('[{\\\"roleId\\\":\\\"'+roleId+'\\\",\\\"permissionId\\\":\\\"'+params+'\\\"}]')[0],\r\n");
      out.write("\t\t        \tdataType:'text',\r\n");
      out.write("\t\t        \tsuccess:function(result){\r\n");
      out.write("\t\t        \t\tvar t = eval('('+result+')');\r\n");
      out.write("\t\t        \t\tif(t.status == -2){\r\n");
      out.write("\t\t        \t\t\t$('#myModalPermissionTree').modal('hide');\r\n");
